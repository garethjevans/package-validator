...
BINARY_NAME := package-validator
GO := GO111MODULE=on GO15VENDOREXPERIMENT=1 go
GO_NOMOD := GO111MODULE=off go
PACKAGE_NAME := github.com/garethjevans/package-validator
ROOT_PACKAGE := github.com/garethjevans/package-validator
ORG := garethjevans
